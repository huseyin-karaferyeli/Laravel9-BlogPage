            ...
            <div class="card-body">
                ...
                <form action="{{route('admin.faq.store')}}" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="basic-default-company" name="question" placeholder="Question">
                    </div>

                    <div class="mb-3">
                        <label for="exampleFormControlTextarea1" class="form-label">Answer</label>
                        <textarea class="form-control" id="answer" rows="3" name="answer" placeholder="Answer"></textarea>
                    </div>
                    ...
                    <div class="card mt-4">
                        <button class="btn btn-primary btn-lg " type="submit">Add New FAQ</button>
                    </div>
                </form>
            </div>
        </div>
