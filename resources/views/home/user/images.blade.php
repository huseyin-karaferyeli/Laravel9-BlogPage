    ...
    <div class="col-xl">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <form action="{{route('userpanel.image.store', ['pid' => $blog -> id])}}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="demo-inline-spacing">
                                ...
                                <a href="{{route('userpanel.image.detail', ['pid' => $blog -> id, 'id' => $rs -> id])}}">
                                    <button class="btn btn-outline-primary" >Detail</button>
                                </a>

                                <a href="{{route('userpanel.image.delete', ['pid' => $blog -> id, 'id' => $rs -> id])}}" onclick="return confirm('Are You Sure? You are deleting an image');">
